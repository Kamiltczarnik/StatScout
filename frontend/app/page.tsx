      ...
      <header className="sticky top-0 z-40 border-b bg-background">
        <div className="container flex h-16 items-center justify-between py-4">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="/teams" className="text-sm font-medium text-muted-foreground hover:text-primary">
              Teams
            </Link>
            <Link href="/players" className="text-sm font-medium text-muted-foreground hover:text-primary">
              Players
            </Link>
            <Link href="/schedule" className="text-sm font-medium text-muted-foreground hover:text-primary">
              Schedule
            </Link>
            <Link href="/scout-picks" className="text-sm font-medium text-muted-foreground hover:text-primary">
              Scout Picks
            </Link>
          </nav>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  ...
                  <Button variant="outline" size="lg">
                    <Link href="/players">View Player Stats</Link>
                  </Button>
                </div>
              </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-10 px-10 md:gap-16 lg:grid-cols-2">
              <div className="space-y-4">
                ...
                <Button asChild>
                  <Link href="/scout-picks">View Scout Picks</Link>
                </Button>
              </div>
      ...
      <footer className="border-t bg-background">
        <div className="container flex flex-col gap-4 py-10 md:flex-row md:gap-8 md:py-12">
          <div className="flex flex-col gap-2 md:gap-4 lg:gap-6">
            ...
            <p className="text-sm text-muted-foreground">Your ultimate NHL statistics and analytics platform</p>
          </div>
          <div className="md:ml-auto grid gap-8 sm:grid-cols-3">
            <div className="grid gap-3 text-sm">
              ...
              <nav className="grid gap-3">
                ...
                <Link href="/scout-picks" className="hover:underline">
                  Scout Picks
                </Link>
              </nav>
            </div>
